---
title: "The influence of female secondary school enrolment on the total fertility rate of a population"
author: "Tauriq Jamalie (3437177), Adnaan Emandien (3540482), Hafeez Sonday (3440252)"
date: "Department of Biodiversity and Conservation Biology, University of the Western Cape,Robert Sobukwe Rd, Bellville, Cape Town, 7535"
output:
  html_document:
    df_print: paged
monofont: PT Mono
...
#####**Pearsons Correlation of the Kenya data**
A Pearson’s product-moment correlation analysis was conducted on the Kenyan dataset as the Shapiro-Wilk test revealed that the data was normally distributed. The test then confirmed that there is indeed a significant difference between percentage of females enrolled in secondary education and total fertility rate denoted by a p-value of <0.05.
